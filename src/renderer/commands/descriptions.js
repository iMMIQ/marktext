const commandDescriptions = Object.freeze({
  ...
  'tabs.switch-to-second': 'Misc: Switch tab to the 2nd',
  'tabs.switch-to-third': 'Misc: Switch tab to the 3rd',
  'tabs.switch-to-fourth': 'Misc: Switch tab to the 4th',
  'tabs.switch-to-fifth': 'Misc: Switch tab to the 5th',
  'tabs.switch-to-sixth': 'Misc: Switch tab to the 6th',
  'tabs.switch-to-seventh': 'Misc: Switch tab to the 7th',
  'tabs.switch-to-eighth': 'Misc: Switch tab to the 8th',
  'tabs.switch-to-ninth': 'Misc: Switch tab to the 9th',
  'tabs.switch-to-tenth': 'Misc: Switch tab to the 10th',
